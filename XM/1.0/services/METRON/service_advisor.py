...
class METRONServiceAdvisor(service_advisor.ServiceAdvisor):
    def getServiceComponentLayoutValidations(self, services, hosts):
        ...
        if metronParsersHost not in kafkaBrokers:
            ...
            items.append(
                {"type": 'host-component', "level": 'ERROR', "message": message, "component-name": 'METRON_PARSERS',
                 "host": metronParsersHost})

        if metronParsersHost not in stormSupervisors:
            message = "Metron must be colocated with an instance of STORM SUPERVISOR"
            items.append(
                {"type": 'host-component', "level": 'WARN', "message": message, "component-name": 'METRON_PARSERS',
                 "host": metronParsersHost})

        if metronRESTHost not in stormSupervisors:
            message = "Metron REST must be colocated with an instance of STORM SUPERVISOR"
            items.append(
                {"type": 'host-component', "level": 'WARN', "message": message, "component-name": 'METRON_REST',
                 "host": metronRESTHost})
        ...
        if metronParsersHost != metronEnrichmentMaster:
            ...
            items.append({"type": 'host-component', "level": 'ERROR', "message": message,
                          "component-name": 'METRON_ENRICHMENT_MASTER', "host": metronEnrichmentMaster})
        ...
        if metronParsersHost != metronIndexingHost:
            ...
            items.append(
                {"type": 'host-component', "level": 'ERROR', "message": message, "component-name": 'METRON_INDEXING',
                 "host": metronIndexingHost})
        ...
        if metronParsersHost != metronProfilerHost:
            ...
            items.append(
                {"type": 'host-component', "level": 'ERROR', "message": message, "component-name": 'METRON_PROFILER',
                 "host": metronProfilerHost})
        ...
        if metronEnrichmentMaster not in hbaseClientHosts:
            ...
            items.append({"type": 'host-component', "level": 'WARN', "message": message,
                          "component-name": 'METRON_ENRICHMENT_MASTER', "host": metronEnrichmentMaster})
    ...
    def getSTORMSiteDesiredValues(self, is_secured):
        ...
        storm_site_desired_values = {
            "topology.classpath": "/etc/hbase:/etc/hadoop"
        }
