...
class XM10NIFIServiceAdvisor(service_advisor.ServiceAdvisor):
    def __init__(self, *args, **kwargs):
        self.as_super = super(XM10NIFIServiceAdvisor, self)
    ...
    def getServiceComponentLayoutValidations(self, services, hosts):
        items = super(XM10NIFIServiceAdvisor, self).getServiceComponentLayoutValidations(services, hosts)
        return items
    ...
    def validateConfigurationsForSite(self, configurations, recommendedDefaults, services, hosts, siteName, method):
        ...
        if properties:
            if siteName == 'nifi-ambari-ssl-config' or siteName == 'nifi-ambari-config':
                ...
                return super(XM10NIFIServiceAdvisor, self).validateConfigurationsForSite(configurations,
