...
def setup_ranger_hbase(upgrade_type=None, service_name="hbase-master",only_download=False):
    import params
    ...
    if params.enable_ranger_hbase:
        ...
        if params.xml_configurations_supported:
            ...
            setup_ranger_plugin('hbase', 'hbase', params.previous_jdbc_jar, params.downloaded_custom_connector,
                                ...
                                component_user=params.hbase_user, component_group=params.user_group,
                                ...
                                component_user_keytab=params.ranger_hbase_keytab if params.security_enabled else None,only_download=only_download)
            ...
            setup_ranger_plugin('hbase', 'hbase', params.previous_jdbc_jar,
                                ...
                                ssl_truststore_password=params.ssl_truststore_password,
                                ssl_keystore_password=params.ssl_keystore_password,
                                stack_version_override=stack_version, skip_if_rangeradmin_down=not params.retryAble,only_download=only_download)
    else:
