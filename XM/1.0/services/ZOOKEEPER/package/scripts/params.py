...
install_dir = config['configurations']['zookeeper-env']['install_dir']
...
# default parameters
zk_home = install_dir
zk_bin = install_dir + '/bin'
zk_cli_shell = install_dir + '/bin/zkCli.sh'
...
zk_server_heapsize_value = default(
    'configurations/zookeeper-env/zk_server_heapsize', "1024m")
