...
install_dir = config['configurations']['doctor-env']['install_dir']
...
principal_name = default('configurations/doctor-env/principal_name',"").replace("_HOST", hostname)
...
drelephant_env_template = config['configurations']['doctor-env']['drelephant_env']
