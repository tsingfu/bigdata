...
elasticServer = os.environ.get('ES_METRICS_CLUSTER_URL', 'http://10.3.138.50:9200')
...
elasticMonitoringCluster = os.environ.get('ES_METRICS_MONITORING_CLUSTER_URL', 'http://10.3.138.50:9200')
