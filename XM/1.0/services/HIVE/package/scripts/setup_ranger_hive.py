...
from ranger_functions_v2 import RangeradminV2
...
def setup_ranger_hive(upgrade_type=None):
    ...
    if params.enable_ranger_hive:
        ...
        if params.xml_configurations_supported:
            ...
            setup_ranger_plugin('hive', 'hive', params.ranger_previous_jdbc_jar,
                                ...
                                component_user=params.hive_user, component_group=params.user_group,
                                cache_service_list=['hiveServer2'],
                                plugin_audit_properties=params.config['configurations']['ranger-hive-audit'],
                                plugin_audit_attributes=params.config['configuration_attributes']['ranger-hive-audit'],
...
def setup_ranger_hive_metastore_service():
    ...
    if params.has_ranger_admin and params.ranger_hive_metastore_lookup:
        ...
        hive_ranger_plugin_config = {
            'username': default('/configurations/ranger-env/admin_username', 'admin'),
            'password': default('/configurations/ranger-env/admin_password', 'admin'),
            'jdbc.driverClassName': params.config['configurations']['ranger-hive-plugin-properties'][
                'jdbc.driverClassName'],
            'jdbc.url': 'none',
            'commonNameForCertificate': params.config['configurations']['ranger-hive-plugin-properties'][
        ...
        ranger_admin_obj = RangeradminV2(
            url=params.config['configurations']['ranger-hive-security']['ranger.plugin.hive.policy.rest.url'],
