...
class HiveServiceCheck(Script):
    ...
    def service_check(self, env):
        ...
        self.check_hive_server(
            env, 'Hive Server', kinit_cmd, params.hive_server_hosts,
        ...
        if params.has_hive_interactive and params.hive_interactive_enabled:
            ...
            Logger.info("-------------------\n")
            self.check_llap(
                env, kinit_cmd, params.hive_interactive_hosts,
                int(format("{hive_server_interactive_port}")),
                params.hive_llap_principal, params.hive_server2_authentication,
                params.hive_transport_mode, params.hive_http_endpoint)
    ...
    def check_hive_server(self, env, server_component_name, kinit_cmd,
        ...
        Logger.info("Waiting for the {0} to start...".format(
  ...
  """
    ...
    def check_llap(self,
        ...
        if params.version:
            upgrade_hive_bin = format("{install_dir}/bin")
        ...
        llap_cmd += format(
            " --hiveconf \"hiveLlapServiceCheck={unique_id}\" -f {install_dir}/scripts/llap/sql/serviceCheckScript.sql")
