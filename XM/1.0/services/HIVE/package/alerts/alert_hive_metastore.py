...
HIVE_CONF_DIR_LEGACY = '/etc/hive'

HIVE_BIN_DIR_LEGACY = '/opt/hive/bin'
...
def get_tokens():
  ...
  """
    return (SECURITY_ENABLED_KEY, SMOKEUSER_KEYTAB_KEY,
            SMOKEUSER_PRINCIPAL_KEY, HIVE_METASTORE_URIS_KEY, SMOKEUSER_KEY,
            KERBEROS_EXECUTABLE_SEARCH_PATHS_KEY, STACK_ROOT)
