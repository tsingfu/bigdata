...
def get_tokens():
  ...
  """
    return (TEMPLETON_PORT_KEY, SECURITY_ENABLED_KEY, SMOKEUSER_KEYTAB_KEY,
            SMOKEUSER_PRINCIPAL_KEY, KERBEROS_EXECUTABLE_SEARCH_PATHS_KEY,
            SMOKEUSER_KEY)
    ...
    if security_enabled:
        ...
        try:
            ...
            url_response = urllib2.urlopen(
                query_url, timeout=connection_timeout)
