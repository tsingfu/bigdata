...
install_dir = config['configurations']['knox-env']['install_dir']
...
knox_bin = format('{install_dir}/bin/gateway.sh')
knox_conf_dir = '/etc/knox'
ldap_bin = format('{install_dir}/bin/ldap.sh')
knox_client_bin = format('{install_dir}/bin/knoxcli.sh')
knox_master_secret_path = format('{install_dir}/data/security/master')
knox_cert_store_path = format('{install_dir}/data/security/keystores/gateway.jks')
knox_data_dir = install_dir + '/data'
...
knox_managed_pid_symlink = install_dir + '/pids'
