...
def setup_logsearch():
    ...
    if params.security_enabled:
        kinit_cmd = format("{kinit_path_local} -kt {logsearch_kerberos_keytab} {logsearch_kerberos_principal};")
    ...
    if params.security_enabled and not params.logsearch_use_external_solr:
        solr_cloud_util.add_solr_roles(params.config,
                                       roles=[params.infra_solr_role_logsearch, params.infra_solr_role_ranger_admin,
