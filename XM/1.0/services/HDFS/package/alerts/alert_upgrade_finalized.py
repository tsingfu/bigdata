...
def get_tokens():
  ...
  """
    return (HDFS_SITE_KEY, NN_HTTP_ADDRESS_KEY, NN_HTTPS_ADDRESS_KEY,
            NN_HTTP_POLICY_KEY, EXECUTABLE_SEARCH_PATHS, KERBEROS_KEYTAB,
            KERBEROS_PRINCIPAL, SECURITY_ENABLED_KEY, SMOKEUSER_KEY)
...
def execute(configurations={}, parameters={}, host_name=None):
  ...
  """
    ...
    if not HDFS_SITE_KEY in configurations:
        return 'SKIPPED', ['{0} is a required parameter for the script'.format(
            HDFS_SITE_KEY)]
