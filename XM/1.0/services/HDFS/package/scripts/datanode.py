            ...
            if not result_issues:  # If all validations passed successfully
                try:
                    ...
                    if ('hdfs-site' not in security_params or
                            'dfs.datanode.keytab.file' not in
                            security_params['hdfs-site'] or
                            'dfs.datanode.kerberos.principal' not in
                    ...
                    cached_kinit_executor(
                        ...
                        ['dfs.datanode.keytab.file'], security_params[
                            'hdfs-site']['dfs.datanode.kerberos.principal'],
