...
class NFSGateway(Script):
    ...
    def security_status(self, env):
        ...
        props_empty_check = ['nfs.keytab.file', 'nfs.kerberos.principal']
        ...
        if 'core-site' in security_params and 'hadoop.security.authentication' in security_params['core-site'] and \
            ...
            if not result_issues:  # If all validations passed successfully
                try:
                    ...
                    if ('hdfs-site' not in security_params or 'nfs.keytab.file'
                            not in security_params['hdfs-site'] or
                            'nfs.kerberos.principal' not in
