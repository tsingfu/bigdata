    ...
    if params.enable_ranger_hdfs:
        ...
        if params.xml_configurations_supported:
            ...
            if params.stack_supports_ranger_kerberos:
                api_version = 'v2'
            setup_ranger_plugin('hadoop', 'hdfs', params.previous_jdbc_jar,
                                ...
                                component_user=params.hdfs_user, component_group=params.user_group,
                                ...
                                api_version=api_version, stack_version_override=stack_version,
