...
druid_home = format("{component_directory}")
druid_conf_dir = '/etc/druid'
...
druid_segment_infoDir = config['configurations']['druid-historical'][
    'druid.segmentCache.infoDir']
druid_segment_cache_locations = config['configurations']['druid-historical'][
    'druid.segmentCache.locations']
druid_tasks_dir = config['configurations']['druid-middlemanager'][
...
druid_extensions = config['configurations']['druid-common'][
    'druid.extensions.pullList']
druid_repo_list = config['configurations']['druid-common'][
    'druid.extensions.repositoryList']
druid_extensions_load_list = config['configurations']['druid-common'][
    'druid.extensions.loadList']
druid_security_extensions_load_list = config['configurations']['druid-common'][
...
druid_node_content_template = config['configurations']['druid-env']['druid_node_content']

# log4j params
log4j_props = config['configurations']['druid-log4j']['content']
#log4j_props_log = config['configurations']['druid-log4j']['log_content']
...
druid_log_maxbackupindex = default(
    '/configurations/druid-logrotate/druid_log_maxbackupindex', 7)
druid_log_maxfilesize = default(
    '/configurations/druid-logrotate/druid_log_maxfilesize', 256)
logrotate_props = config['configurations']['druid-logrotate']['content']

# Metadata storage
metadata_storage_user = config['configurations']['druid-common'][
    'druid.metadata.storage.connector.user']
metadata_storage_password = config['configurations']['druid-common'][
    'druid.metadata.storage.connector.password']
metadata_storage_db_name = config['configurations']['druid-common'][
    'database_name']
metadata_storage_db_name = config['configurations']['druid-common'][
    'database_name']
metadata_storage_type = config['configurations']['druid-common'][
    'druid.metadata.storage.type']
metadata_storage_url = config['configurations']['druid-common'][
...
if 'mysql' == metadata_storage_type:
    ...
    connector_download_dir = format(
        "{druid_extensions_dir}/mysql-metadata-storage")
...
# Kerberos
druid_principal_name = default(
    '/configurations/druid-common/druid.hadoop.security.kerberos.principal',
    'missing_principal')
druid_user_keytab = default(
    '/configurations/druid-common/druid.hadoop.security.kerberos.keytab',
    'missing_keytab')
...
superset_log_dir = default(
    "/configurations/druid-superset-env/superset_log_dir", '/var/log/superset')
superset_pid_dir = status_params.superset_pid_dir
superset_config_dir = '/etc/superset'
superset_admin_user = config['configurations']['druid-superset-env'][
    'superset_admin_user']
superset_admin_password = config['configurations']['druid-superset-env'][
    'superset_admin_password']
superset_admin_firstname = config['configurations']['druid-superset-env'][
    'superset_admin_firstname']
superset_admin_lastname = config['configurations']['druid-superset-env'][
    'superset_admin_lastname']
superset_admin_email = config['configurations']['druid-superset-env'][
    'superset_admin_email']
superset_env_sh_template = config['configurations']['druid-superset-env'][
    'content']
superset_protocol = "http"
superset_webserver_address = config['configurations']['druid-superset'][
    'SUPERSET_WEBSERVER_ADDRESS']
superset_webserver_port = config['configurations']['druid-superset'][
    'SUPERSET_WEBSERVER_PORT']
superset_timeout = config['configurations']['druid-superset'][
    'SUPERSET_TIMEOUT']
superset_workers = config['configurations']['druid-superset'][
    'SUPERSET_WORKERS']
superset_hosts = default('/clusterHostInfo/superset_hosts', None)

# superset database configs
superset_db_type = config['configurations']['druid-superset'][
    'SUPERSET_DATABASE_TYPE']
superset_db_name = config['configurations']['druid-superset'][
    'SUPERSET_DATABASE_NAME']
superset_db_password = config['configurations']['druid-superset'][
    'SUPERSET_DATABASE_PASSWORD']
superset_db_user = config['configurations']['druid-superset'][
    'SUPERSET_DATABASE_USER']
superset_db_port = config['configurations']['druid-superset'][
    'SUPERSET_DATABASE_PORT']
superset_db_host = config['configurations']['druid-superset'][
    'SUPERSET_DATABASE_HOSTNAME']

superset_db_uri = None
if superset_db_type == "sqlite":
    superset_db_uri = format(
        "sqlite:///{superset_config_dir}/{superset_db_name}.db")
...
druid_coordinator_port = config['configurations']['druid-coordinator'][
    'druid.port']
