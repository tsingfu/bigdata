...
slaptest -f /etc/openldap/slapd.conf -F /etc/openldap/slapd.d;chown -R ldap:ldap /etc/openldap/slapd.d;chmod -R 000 /etc/openldap/slapd.d;chmod -R u+rwx /etc/openldap/slapd.d
#
