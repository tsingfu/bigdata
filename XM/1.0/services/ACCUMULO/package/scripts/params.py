...
install_dir = config['configurations']['accumulo-env']['install_dir']
download_url = config['configurations']['accumulo-env']['download_url']
...
# service locations
hadoop_prefix = config['configurations']['hadoop-env']['install_dir']
hadoop_bin_dir = hadoop_prefix + '/bin'
zookeeper_home = config['configurations']['zookeeper-env']['install_dir']

hadoop_conf_dir = '/etc/hadoop'

# accumulo local directory structure
log_dir = config['configurations']['accumulo-env']['accumulo_log_dir']
client_script = format("{install_dir}/bin/accumulo")
...
if security_enabled:
    bare_accumulo_principal = get_bare_principal(
        config['configurations']['accumulo-site']['general.kerberos.principal'])
