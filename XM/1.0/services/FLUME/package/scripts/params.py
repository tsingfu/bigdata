...
install_dir = config['configurations']['flume-env']['install_dir']
...
flume_conf_dir = default("/configurations/flume-env/flume_conf_dir", '/etc/flume')
flume_user = 'flume'
flume_group = 'flume'
...
flume_hive_home = '/opt/hive/lib'
flume_hcat_home = '/opt/hive/hcatalog/share/webhcat/svr/lib/'
