...
def setup_ranger_storm(upgrade_type=None):
    ...
    if params.enable_ranger_storm and params.security_enabled:
        ...
        if params.xml_configurations_supported:
            ...
            setup_ranger_plugin('storm', 'storm', params.previous_jdbc_jar,
                                ...
                                component_user=params.storm_user, component_group=params.user_group,
                                cache_service_list=['storm'],
                                plugin_audit_properties=params.config['configurations']['ranger-storm-audit'],
                                plugin_audit_attributes=params.config['configuration_attributes']['ranger-storm-audit'],
        ...
        if params.enable_ranger_storm and params.has_namenode and params.security_enabled:
            Logger.info(
            ...
            setup_core_site_for_required_plugins(component_user=params.storm_user, component_group=params.user_group,
                                                 create_core_site_path=site_files_create_path, config=params.config)
