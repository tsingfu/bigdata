...
spark_thrift_server_pid_file = format(
    "{spark_pid_dir}/spark-{hive_user}-org.apache.spark.sql.hive.thriftserver.HiveThriftServer2-1.pid")
...
if "livy2-env" in config['configurations']:
    ...
    livy2_server_pid_file = format(
        "{livy2_pid_dir}/livy-{livy2_user}-server.pid")
